...
public class DriveMapBaseActivity extends BaseActivity implements AMapNaviListener, AMapNaviViewListener{
    ...
    private String nativeSyle=Utils.STYLE_DRIVE;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        requestWindowFeature(Window.FEATURE_NO_TITLE);
        
        businessEntity=(BusinessEntity) getIntent().getSerializableExtra("DriveMapBaseActivity");
