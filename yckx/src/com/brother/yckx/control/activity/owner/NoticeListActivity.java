...
public class NoticeListActivity extends BaseActivity implements IXListViewListener{
	...
	private void doInbackgound(){
		new Thread(new Runnable() {
			...
			public void run() {//message/list/{page}/{size}
				...
				String token=PrefrenceConfig.getUserMessage(NoticeListActivity.this).getUserToken();
        ...
        listView.setOnMenuItemClickListener(new OnMenuItemClickListener() {
            ...
            public void onMenuItemClick(int position, SwipeMenu menu, int index) {
                ...
                case 0:
                	...
                	Intent intent=new Intent(NoticeListActivity.this,FormDetailActivity.class);
