...
import com.brother.yckx.control.frgament.washer.WasherMoreFragment;
...
public class WasherHistoryFormActivity extends BaseActivity implements FragmentItemOnClickListener{
	...
	private String[] names = { "全部", "处理中", "待评价", "已完成", "已取消", "已作废" };
	...
	private class MyAdapter extends IndicatorFragmentPagerAdapter {
		...
		public Fragment getFragmentForPage(int position) {
			WasherMoreFragment fragment=new WasherMoreFragment();
		//	WasherMoreFragment fragment = new MoreFragment();
	...
	private View.OnClickListener listener=new View.OnClickListener() {
		...
		public void onClick(View arg0) {
			if(arg0.getId()==R.id.iv_action_left){
				WasherHistoryFormActivity.this.finish();
			}
