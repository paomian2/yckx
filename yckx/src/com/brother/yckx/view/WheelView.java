...
public class WheelView extends ScrollView {
	...
	private void initView() {
        ...
        mPaintBorder.setColor(COLOR_NORMAL);
    ...
    public void setBackgroundDrawable(Drawable background) {
        background = new Drawable() {
            ...
            public void draw(Canvas canvas) {
                ...
                //设置横线的长度mItemWidth屏幕长度
                canvas.drawLine(0, mBorderHeight[0], mItemWidth, mBorderHeight[0], mPaintBorder);
                canvas.drawLine(0, mBorderHeight[1], mItemWidth, mBorderHeight[1], mPaintBorder);
            }
