...
public class SenderEntity implements Serializable{
	...
	public SenderEntity(String id, String userPhone, String userImageUrl,
	...
	public String toString() {
		return "SenderEntity [id=" + id + ", userPhone=" + userPhone
				+ ", userImageUrl=" + userImageUrl + ", userRegistTime="
				+ userRegistTime + ", userRole=" + userRole + ", userOpStatus="
				+ userOpStatus + ", userOrderCount=" + userOrderCount
				+ ", userTotalScore=" + userTotalScore + ", userCommentCount="
				+ userCommentCount + ", wowo=" + wowo + "]";
	}
